...
update: a sum for grades and a sum for extra credit in separated colmus
*/
...
foreach (string name in studentNames)
{
    ...
    */
    ...
    //extraCredit/= GradedExtraCredit;
    //extraCreditPoints/= GradedExtraCredit;
